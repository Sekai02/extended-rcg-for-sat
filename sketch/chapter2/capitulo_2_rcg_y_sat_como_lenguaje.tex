...
Una vez presentadas la clausura bajo intersección y la comparación con
las gramáticas libres del contexto, en la próxima subsección se analiza
...
además, la dirección inversa: todo lenguaje en $P$ admite una RCG
que lo reconoce.
...
La conjunción $A_1 \wedge A_2$ es simétrica. Si en el autómata de $A_1$
...
equivalente a una pila~\cite{fernandezarias2007}. En la pila se guarda
