...
Las gramáticas de concatenación de rango son el formalismo de base
sobre el que se desarrolla el resto del trabajo. Los conceptos básicos
...
limitaciones que motivó la propuesta original de las RCG. En esta
sección se describen las propiedades de clausura que demuestran la
modularidad del formalismo y la caracterización en términos de
complejidad.
...
complemento de una RCG es también una RCG.
\end{teorema}

La demostración del teorema anterior se realiza
en~\cite{boullier1998proposal}.
...
Una vez presentadas la clausura bajo operaciones de conjuntos y la
expresividad de las RCG sobre las CFG, en la próxima subsección se
analiza la caracterización del formalismo en términos de la clase
$PTIME$, resultado que motiva la elección de las RCG en este trabajo.
...
En~\cite{fernandezarias2007} se propone una estrategia para resolver
...
En~\cite{aguileralopez2016} se extiende la idea anterior al emplear
...
En~\cite{gomezmolina2025} se propone una estrategia diferente: en lugar de
...
gramática propuesta en~\cite{gomezmolina2025} dentro de la jerarquía de
